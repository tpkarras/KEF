...
$cipher_options = [["string" => "128", "compatible" => [0, 1, 2]], ["string" => "192", "compatible" => [0, 1, 2]], ["string" => "256", "compatible" => [0, 1, 2]], ["string" => "cbc", "compatible" => [0, 1, 2, 4, 6]], ["string" => "ccm", "compatible" => [0, 1]], ["string" => "cfb", "compatible" => [0, 1, 2, 4, 6]], ["string" => "cfb1", "compatible" => [0, 1, 2, 4]], ["string" => "cfb8", "compatible" => [0, 1, 2, 4]], ["string" => "ctr", "compatible" => [0, 1, 2, 6]], ["string" => "cts", "compatible" => [0, 2]], ["string" => "ecb", "compatible" => [0, 1, 2, 4, 6]], ["string" => "ede", "compatible" => [4]], ["string" => "ede3", "compatible" => [4]], ["string" => "gcm", "compatible" => [0, 1]], ["string" => "inv", "compatible" => [0]], ["string" => "ocb", "compatible" => [0]], ["string" => "ofb", "compatible" => [0, 1, 2, 4, 6]], ["string" => "pad", "compatible" => [0]], ["string" => "poly1305", "compatible" => [3]], ["string" => "siv", "compatible" => [0]], ["string" => "wrap", "compatible" => [0, 4, 5]], ["string" => "xts", "compatible" => [0]]];
